#!/usr/bin/env bash
# =====================================================================
#  n8n + PostgreSQL backup script for development
# =====================================================================
...
POSTGRES_CONTAINER=${POSTGRES_CONTAINER:-postgresdb_dev}
DB_NAME=${POSTGRES_DB:-n8n_database}
N8N_VOLUME_NAME=${N8N_VOLUME_NAME:-n8n_data_dev}
...
BACKUP_DIR="$N8N_BACKUP_DIR_HOST/dev"
...
echo "=================================================================="
echo "BẮT ĐẦU backup DEVELOPMENT lúc:  $(date '+%F %T')"
...
echo "------------------------------------------------------------------"
if [[ "$FAILED" -eq 0 ]]; then
  echo "✅  Backup DEVELOPMENT hoàn tất thành công."
else
  echo "❌  Backup DEVELOPMENT hoàn tất nhưng CÓ LỖI (xem log)."
fi
