...
docker-compose -f docker-compose.yml -f docker-compose.staging.yml pull || handle_error "Không thể pull images"
...
docker-compose -f docker-compose.yml -f docker-compose.staging.yml build || handle_error "Không thể build images"
