...
/// <summary>
/// Controller for managing expected transactions. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets paginated expected transactions based on filtering and sorting criteria. (EN)
    /// <br/>
    /// Lấy danh sách các giao dịch dự kiến có phân trang dựa trên tiêu chí lọc và sắp xếp. (VI)
    /// </summary>
    /// <param name="request">
    /// The request object containing pagination, filtering, and sorting details. (EN)
    /// <br/>
    /// Đối tượng request chứa thông tin phân trang, lọc và sắp xếp. (VI)
    /// </param>
    /// <returns>
    /// A paginated list of expected transactions if successful, or a status code indicating an error. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets pending expected transactions for a user by user ID. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A list of pending expected transactions. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets upcoming expected transactions for a user within a specified number of days. (EN)
    /// <br/>
    ...
    /// </param>
    /// <param name="days">
    /// The number of upcoming days to retrieve transactions for. Defaults to 30. (EN)
    /// <br/>
    /// Số ngày sắp tới để lấy giao dịch. Mặc định là 30. (VI)
    /// </param>
    /// <returns>
    /// A list of upcoming expected transactions. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets expected transactions by recurring transaction template ID. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A list of expected transactions associated with the specified template. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets expected transactions by account ID. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A list of expected transactions associated with the specified account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets expected transactions for a user within a specified date range. (EN)
    /// <br/>
    ...
    /// The start date of the range. (EN)
    /// <br/>
    /// Ngày bắt đầu của khoảng thời gian. (VI)
    /// </param>
    /// <param name="endDate">
    /// The end date of the range. (EN)
    /// <br/>
    /// Ngày kết thúc của khoảng thời gian. (VI)
    /// </param>
    /// <returns>
    /// A list of expected transactions within the specified date range. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Confirms an expected transaction and links it to an actual transaction. (EN)
    /// <br/>
    /// Xác nhận một giao dịch dự kiến và liên kết nó với một giao dịch thực tế. (VI)
    /// </summary>
    /// <param name="expectedTransactionId">
    /// The ID of the expected transaction to confirm. (EN)
    /// <br/>
    /// ID của giao dịch dự kiến cần xác nhận. (VI)
    /// </param>
    /// <param name="request">
    /// The request containing the ID of the actual transaction to link. (EN)
    /// <br/>
    /// Request chứa ID của giao dịch thực tế để liên kết. (VI)
    /// </param>
    /// <returns>
    /// An Ok result if successful, or NotFound if the expected transaction is not found or cannot be confirmed. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Cancels an expected transaction by its ID. (EN)
    /// <br/>
    /// Hủy một giao dịch dự kiến dựa trên ID của nó. (VI)
    /// </summary>
    /// <param name="expectedTransactionId">
    /// The ID of the expected transaction to cancel. (EN)
    /// <br/>
    /// ID của giao dịch dự kiến cần hủy. (VI)
    /// </param>
    /// <param name="request">
    /// The request containing the reason for cancellation. (EN)
    /// <br/>
    /// Request chứa lý do hủy. (VI)
    /// </param>
    /// <returns>
    /// An Ok result if successful, or NotFound if the expected transaction is not found or cannot be cancelled. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Adjusts the amount of an expected transaction by its ID. (EN)
    /// <br/>
    /// Điều chỉnh số tiền của một giao dịch dự kiến dựa trên ID của nó. (VI)
    /// </summary>
    /// <param name="expectedTransactionId">
    /// The ID of the expected transaction to adjust. (EN)
    /// <br/>
    /// ID của giao dịch dự kiến cần điều chỉnh. (VI)
    /// </param>
    /// <param name="request">
    /// The request containing the new amount and reason for adjustment. (EN)
    /// <br/>
    /// Request chứa số tiền mới và lý do điều chỉnh. (VI)
    /// </param>
    /// <returns>
    /// An Ok result if successful, or NotFound if the expected transaction is not found or cannot be adjusted. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets the cash flow forecast for a user within a specified date range. (EN)
    /// <br/>
    ...
    /// </param>
    /// <param name="startDate">
    /// The start date of the forecast range. (EN)
    /// <br/>
    /// Ngày bắt đầu của khoảng thời gian dự báo. (VI)
    /// </param>
    /// <param name="endDate">
    /// The end date of the forecast range. (EN)
    /// <br/>
    /// Ngày kết thúc của khoảng thời gian dự báo. (VI)
    /// </param>
    /// <returns>
    /// An Ok result with the cash flow forecast data if successful. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets the category-based forecast for a user within a specified date range. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// An Ok result with the category forecast data if successful. (EN)
    /// <br/>
