...
/// <summary>
/// Controller for managing recurring transaction templates. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets paginated recurring transaction templates. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A paginated list of recurring transaction templates if successful, or a status code indicating an error. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets active templates for a user by user ID. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A list of active recurring transaction templates. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets templates by account ID. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A list of recurring transaction templates for the specified account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Toggles the active status of a recurring transaction template by its ID. (EN)
    /// <br/>
    /// Bật/tắt trạng thái hoạt động của mẫu giao dịch định kỳ dựa trên ID của nó. (VI)
    /// </summary>
    /// <param name="templateId">
    /// The ID of the template to toggle the active status for. (EN)
    /// <br/>
    /// ID của mẫu cần bật/tắt trạng thái hoạt động. (VI)
    /// </param>
    /// <param name="isActive">
    /// The new active status. (EN)
    /// <br/>
    /// Trạng thái hoạt động mới. (VI)
    /// </param>
    /// <returns>
    /// An Ok result if successful, or NotFound if the template is not found. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Calculates the next execution date for a recurring transaction template by its ID. (EN)
    /// <br/>
    /// Tính ngày thực hiện tiếp theo cho mẫu giao dịch định kỳ dựa trên ID của nó. (VI)
    /// </summary>
    /// <param name="templateId">
    /// The ID of the template. (EN)
    /// <br/>
    /// ID của mẫu. (VI)
    /// </param>
    /// <returns>
    /// An Ok result with the next execution date if successful, or NotFound if the template is not found. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Generates expected transactions for a specific recurring transaction template. (EN)
    /// <br/>
    ...
    /// The number of days in advance to generate transactions for. Defaults to 30. (EN)
    /// <br/>
    /// Số ngày tạo giao dịch dự kiến trước. Mặc định là 30. (VI)
    /// </param>
    /// <returns>
    /// An Ok result if successful, or BadRequest if an error occurs. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Generates expected transactions for all active recurring transaction templates. (EN)
    /// <br/>
