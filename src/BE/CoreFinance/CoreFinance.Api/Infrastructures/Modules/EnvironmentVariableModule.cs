...
/// <summary>
/// Represents a module for accessing environment variables and configuring application settings. (EN)
/// <br/>
...
{
    /// <summary>
    /// Adds configuration settings from appsettings.json and environment variables to the service collection. (EN)
    /// <br/>
