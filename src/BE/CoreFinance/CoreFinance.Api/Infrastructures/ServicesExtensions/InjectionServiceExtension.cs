...
/// <summary>
/// Provides extension methods for dependency injection and service configuration. (EN)
/// <br/>
...
{
    /// <summary>
    /// Adds various services and dependencies to the service collection, including HttpContextAccessor, AutoMapper, UnitOfWork, Validators, Repositories, and Application Services. (EN)
    /// <br/>
    /// Thêm các dịch vụ và dependency khác nhau vào service collection, bao gồm HttpContextAccessor, AutoMapper, UnitOfWork, Validators, Repositories và Application Services. (VI)
    /// </summary>
    /// <param name="services">
    /// The IServiceCollection to add services to. (EN)
    /// <br/>
