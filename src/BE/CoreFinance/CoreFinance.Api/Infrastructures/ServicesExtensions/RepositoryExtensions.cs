...
/// <summary>
/// Provides extension methods for registering repositories. (EN)
/// <br/>
...
{
    /// <summary>
    /// Registers base repositories with proxied scoped lifetime. (EN)
    /// <br/>
    /// Đăng ký các repository cơ sở với lifetime scoped được proxy. (VI)
    /// </summary>
    /// <param name="services">
    /// The IServiceCollection to add repositories to. (EN)
    /// <br/>
