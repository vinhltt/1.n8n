...
/// <summary>
/// Represents a request to update an existing account. (EN)
/// <br/>
...
{
    /// <summary>
    /// The updated name of the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated type of the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated card number associated with the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated currency of the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated available credit limit for credit card accounts (optional). (EN)
    /// <br/>
