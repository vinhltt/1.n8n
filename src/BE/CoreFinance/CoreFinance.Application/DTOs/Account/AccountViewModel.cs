...
/// <summary>
/// Represents a view model for account data. (EN)
/// <br/>
...
{
    /// <summary>
    /// The ID of the user who owns the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The type of the account (e.g., checking, savings, credit card). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The card number associated with the account (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The currency of the account (e.g., "VND", "USD"). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The initial balance of the account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The current balance of the account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The available credit limit for credit card accounts (optional). (EN)
    /// <br/>
