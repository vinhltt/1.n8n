...
/// <summary>
/// Represents a request to adjust an expected transaction amount. (EN)
/// <br/>
...
{
    /// <summary>
    /// The new adjusted amount for the expected transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The reason for the adjustment. (EN)
    /// <br/>
    /// Lý do điều chỉnh. (VI)
    /// </summary>
