...
/// <summary>
/// Represents a request to update an existing expected transaction. (EN)
/// <br/>
...
{
    /// <summary>
    /// The updated expected date of the transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated expected amount of the transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated description of the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated category of the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated status of the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Additional updated notes about the expected transaction (optional). (EN)
    /// <br/>
