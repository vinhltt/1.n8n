...
/// <summary>
/// Represents a view model for expected transaction data. (EN)
/// <br/>
...
{
    /// <summary>
    /// The ID of the recurring transaction template this expected transaction is based on. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The ID of the user associated with the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The ID of the account associated with the expected transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The ID of the actual transaction linked to this expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The expected amount of the transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// A description of the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The type of the recurring transaction (e.g., income, expense). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The category of the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The current status of the expected transaction (e.g., Pending, Confirmed, Cancelled). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Indicates if the expected transaction amount has been adjusted. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The original expected amount before any adjustment (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The reason for the adjustment (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Additional notes about the expected transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The date and time the expected transaction was generated. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The date and time the expected transaction was processed (confirmed or cancelled) (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The creation date and time of the expected transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The last update date and time of the expected transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The name of the recurring transaction template this expected transaction is based on. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The name of the associated account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The type of the associated account. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Indicates if this expected transaction has been linked to an actual transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The number of days until the expected transaction is due. (EN)
    /// <br/>
