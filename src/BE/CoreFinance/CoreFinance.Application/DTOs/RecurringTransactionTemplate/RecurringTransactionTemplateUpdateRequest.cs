...
/// <summary>
/// Represents a request to update an existing recurring transaction template. (EN)
/// <br/>
...
{
    /// <summary>
    /// The updated name of the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated description of the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated amount of the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated type of recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated category of the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated frequency of the recurrence (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated custom interval in days for recurring transactions with custom frequency (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated start date for the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated end date for the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated Cron expression for complex recurrence patterns (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated active status of the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Indicates if expected transactions should be automatically generated from this template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The updated number of days in advance to generate expected transactions for (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Additional updated notes about the template (optional). (EN)
    /// <br/>
