...
/// <summary>
/// Represents a view model for recurring transaction template data. (EN)
/// <br/>
...
{
    /// <summary>
    /// The ID of the user who owns the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// A description of the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The amount of the recurring transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The type of recurring transaction (e.g., income, expense). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The category of the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The frequency of the recurrence (e.g., daily, weekly, monthly). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The custom interval in days for recurring transactions with custom frequency (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The next scheduled execution date for the recurring transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The start date for the recurring transaction. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The end date for the recurring transaction (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The Cron expression for complex recurrence patterns (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Indicates if the template is currently active. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Indicates if expected transactions should be automatically generated from this template. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The number of days in advance to generate expected transactions for. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Additional notes about the template (optional). (EN)
    /// <br/>
    ...
    /// <summary>
    /// The creation date and time of the template. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The last update date and time of the template. (EN)
    /// <br/>
    ...
    /// <summary>
    /// The number of expected transactions generated from this template. (EN)
    /// <br/>
