    ...
    where TViewModel : BaseViewModel<TKey>, new()
{
    ...
    /// <summary>
    /// Soft deletes an entity by its identifier asynchronously.<br/>(EN) Soft deletes an entity by its identifier asynchronously.<br/>(VI) Xóa mềm một entity theo định danh của nó một cách bất đồng bộ.
    /// </summary>
    /// <param name="id">The identifier of the entity.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains the number of state entries written to the database.</returns>
    ...
    /// <summary>
    /// Updates an entity asynchronously.<br/>(EN) Updates an entity asynchronously.<br/>(VI) Cập nhật một entity một cách bất đồng bộ.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new entity asynchronously.<br/>(EN) Creates a new entity asynchronously.<br/>(VI) Tạo một entity mới một cách bất đồng bộ.
    /// </summary>
    ...
    /// <summary>
    /// Creates multiple new entities asynchronously.<br/>(EN) Creates multiple new entities asynchronously.<br/>(VI) Tạo nhiều entity mới một cách bất đồng bộ.
    /// </summary>
