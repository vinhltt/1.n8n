...
/// <summary>
/// Represents an attribute used to specify SQL parameter details for a property. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets or sets the database type of the SQL parameter. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets the name of the SQL parameter, prefixed with "@". (EN)
    /// <br/>
