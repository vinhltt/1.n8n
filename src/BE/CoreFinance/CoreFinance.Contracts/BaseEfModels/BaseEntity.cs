...
/// <summary>
/// Base entity class providing common properties for database entities. (EN)
/// <br/>
...
public abstract class BaseEntity<TKey> //: ICloneable
{
    ...
    /// <summary>
    /// Sets values for update properties. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the unique identifier for the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the creation timestamp of the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the last update timestamp of the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the identifier of the user who created the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the identifier of the user who last updated the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets a flag indicating if the entity has been soft-deleted (optional). (EN)
    /// <br/>
