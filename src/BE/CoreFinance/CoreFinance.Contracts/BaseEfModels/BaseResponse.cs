...
/// <summary>
/// Base response class for API responses. (EN)
/// <br/>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BaseResponse{T}"/> class. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the status code of the response. (EN)
    /// <br/>
    /// Lấy hoặc đặt mã trạng thái của phản hồi. (VI)
    /// </summary>
    public int? StatusCode { get; set; }
    /// <summary>
    /// Gets or sets the body of the response. (EN)
    /// <br/>
    /// Lấy hoặc đặt nội dung của phản hồi. (VI)
    /// </summary>
    public T? Body { get; set; }
    /// <summary>
    /// Gets or sets the message of the response. (EN)
    /// <br/>
