...
/// <summary>
/// Represents a global variable holder. (EN)
/// <br/>
...
public class GlobalVariable<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GlobalVariable{T}"/> class with the specified object. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets the object held by the global variable. (EN)
    /// <br/>
