...
/// <summary>
/// Represents database settings options. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets or sets a value indicating whether to enable detailed errors. (EN)
    /// <br/>
    /// Lấy hoặc đặt giá trị cho biết có bật lỗi chi tiết hay không. (VI)
    /// </summary>
    public bool? EnableDetailedErrors { get; set; }
    /// <summary>
    /// Gets or sets a value indicating whether to enable sensitive data logging. (EN)
    /// <br/>
