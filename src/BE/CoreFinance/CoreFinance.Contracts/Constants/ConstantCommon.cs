...
/// <summary>
/// Provides common constant values. (EN)
/// <br/>
...
{
    /// <summary>
    /// Represents a constant message for when the page number is below 1. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Represents a constant message for when the page size is less than 1. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Represents a constant message for when the page index is out of range. (EN)
    /// <br/>
