...
/// <summary>
/// Defines the interface for a base tree structure view model. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets or sets the data associated with the tree node. (EN)
    /// <br/>
    /// Lấy hoặc đặt dữ liệu liên quan đến nút cây. (VI)
    /// </summary>
    public T Data { get; set; }
    /// <summary>
    /// Gets or sets the list of child nodes. (EN)
    /// <br/>
