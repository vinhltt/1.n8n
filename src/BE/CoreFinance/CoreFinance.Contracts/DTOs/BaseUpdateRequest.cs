...
/// <summary>
/// Base abstract class for update request DTOs providing common properties. (EN)
/// <br/>
...
{
    /// <summary>
    /// Gets or sets the unique identifier for the entity to update. (EN)
    /// <br/>
    /// Lấy hoặc đặt định danh duy nhất cho thực thể cần cập nhật. (VI)
    /// </summary>
    public virtual TKey? Id { get; set; }
    /// <summary>
    /// Gets or sets a flag indicating if the entity should be soft-deleted (optional). (EN)
    /// <br/>
