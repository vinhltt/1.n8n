...
/// <summary>
/// Represents a Data Transfer Object for user login information. (EN)
/// <br/>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LoginDto"/> class. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LoginDto"/> class with username and password. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets or sets the username. (EN)
    /// <br/>
    /// Lấy hoặc đặt tên người dùng. (VI)
    /// </summary>
    public string? UserName { get; set; }
    /// <summary>
    /// Gets or sets the password. (EN)
    /// <br/>
