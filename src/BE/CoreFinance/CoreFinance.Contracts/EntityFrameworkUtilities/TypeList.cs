...
public static class TypeList
{
    ...
    /// <summary>
    /// Determines whether a given type is a simple type, including nullable variations. (EN)
    /// <br/>
