...
/// <summary>
/// Extension methods for collections. (EN)
/// <br/>
...
{
    /// <summary>
    /// Checks if the provided collection is null or empty. (EN)
    /// <br/>
    /// Kiểm tra xem tập hợp được cung cấp có null hoặc rỗng hay không. (VI)
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements in the collection. (EN)
    /// <br/>
    /// Kiểu của các phần tử trong tập hợp. (VI)
    /// </typeparam>
    /// <param name="source">
    /// The input collection. (EN)
    /// <br/>
    /// Tập hợp đầu vào. (VI)
    /// </param>
    /// <returns>
    /// <c>true</c> if the collection is null or empty; otherwise, <c>false</c>. (EN)
    /// <br/>
