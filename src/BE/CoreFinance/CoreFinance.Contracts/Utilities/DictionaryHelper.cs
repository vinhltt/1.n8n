...
/// <summary>
/// Provides helper methods for working with dictionaries. (EN)
/// <br/>
...
{
    /// <summary>
    /// Adds a range of key-value pairs from one dictionary to another. If a key already exists in the source dictionary, its value is updated. (EN)
    /// <br/>
    /// Thêm một loạt các cặp khóa-giá trị từ từ điển này sang từ điển khác. Nếu một khóa đã tồn tại trong từ điển nguồn, giá trị của nó sẽ được cập nhật. (VI)
    /// </summary>
    /// <param name="source">
    /// The source dictionary to add items to. (EN)
    /// <br/>
    /// Từ điển nguồn để thêm các mục vào. (VI)
    /// </param>
    /// <param name="dictionaryToAdd">
    /// The dictionary containing items to add. (EN)
    /// <br/>
    ...
    /// <returns>
    /// The source dictionary after adding the items. (EN)
    /// <br/>
