...
/// <summary>
/// Provides helper methods for file operations. (EN)
/// <br/>
...
{
    /// <summary>
    /// Reads the content of a file asynchronously. (EN)
    /// <br/>
    /// Đọc nội dung của một tệp một cách bất đồng bộ. (VI)
    /// </summary>
    /// <param name="filepath">
    /// The full path to the file. (EN)
    /// <br/>
    /// Đường dẫn đầy đủ đến tệp. (VI)
    /// </param>
    /// <returns>
    /// The content of the file as a string. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets the directory path of the executing application. (EN)
    /// <br/>
    /// Lấy đường dẫn thư mục của ứng dụng đang thực thi. (VI)
    /// </summary>
    /// <returns>
    /// The directory path of the application. (EN)
    /// <br/>
