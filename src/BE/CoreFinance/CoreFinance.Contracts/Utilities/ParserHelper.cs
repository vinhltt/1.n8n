...
/// <summary>
/// Provides helper methods for parsing and data conversion. (EN)
/// <br/>
...
{
    /// <summary>
    /// Regex pattern to match underscores at the beginning of a string. (EN)
    /// <br/>
    /// Mẫu Regex để khớp với các dấu gạch dưới ở đầu chuỗi. (VI)
    /// </summary>
    public static readonly string TypePascalCaseStringPattern = @"^_+";
    /// <summary>
    /// Regex pattern to match lowercase letter followed by uppercase letter for snake_case conversion. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Converts a string from PascalCase or camelCase to snake_case. (EN)
    /// <br/>
    /// Chuyển đổi một chuỗi từ PascalCase hoặc camelCase sang snake_case. (VI)
    /// </summary>
    /// <param name="value">
    /// The string to convert. (EN)
    /// <br/>
    /// Chuỗi cần chuyển đổi. (VI)
    /// </param>
    /// <returns>
    /// The snake_case representation of the input string. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Removes leading, trailing, and multiple internal spaces from a string. (EN)
    /// <br/>
    /// Xóa khoảng trắng ở đầu, cuối và nhiều khoảng trắng bên trong chuỗi. (VI)
    /// </summary>
    /// <param name="value">
    /// The string to trim. (EN)
    /// <br/>
    /// Chuỗi cần cắt khoảng trắng. (VI)
    /// </param>
    /// <returns>
    /// The trimmed string. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Parses a JSON string to an object of the specified type, returning a default instance of T on failure. (EN)
    /// <br/>
    /// Phân tích cú pháp chuỗi JSON thành đối tượng thuộc kiểu được chỉ định, trả về một thể hiện T mặc định khi thất bại. (VI)
    /// </summary>
    /// <param name="data">
    /// The JSON string to parse. (EN)
    /// <br/>
    /// Chuỗi JSON cần phân tích cú pháp. (VI)
    /// </param>
    /// <param name="result">
    /// When this method returns, contains the parsed object if the parsing was successful, or a default value of T if the parsing failed. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Parses a JSON string to an object of the specified type. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Serializes an object to a JSON string, returning an empty string on failure. (EN)
    /// <br/>
    /// Tuần tự hóa đối tượng thành chuỗi JSON, trả về chuỗi rỗng khi thất bại. (VI)
    /// </summary>
    /// <param name="data">
    /// The object to serialize. (EN)
    /// <br/>
    /// Đối tượng cần tuần tự hóa. (VI)
    /// </param>
    /// <typeparam name="T">The type of the object to serialize.</typeparam>
    /// <returns>
    /// The JSON string representation of the object, or an empty string if serialization failed. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Serializes an object to a Base64 encoded JSON string, returning null on failure. (EN)
    /// <br/>
    /// Tuần tự hóa đối tượng thành chuỗi JSON mã hóa Base64, trả về null khi thất bại. (VI)
    /// </summary>
    /// <param name="data">
    /// The object to serialize and encode. (EN)
    /// <br/>
    /// Đối tượng cần tuần tự hóa và mã hóa. (VI)
    /// </param>
    /// <typeparam name="T">The type of the object to serialize.</typeparam>
    /// <returns>
    /// The Base64 encoded JSON string representation of the object, or null if serialization or encoding failed. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Encodes a string to a Base64 string. (EN)
    /// <br/>
    /// Mã hóa chuỗi thành chuỗi Base64. (VI)
    /// </summary>
    /// <param name="plainText">
    /// The string to encode. (EN)
    /// <br/>
    /// Chuỗi cần mã hóa. (VI)
    /// </param>
    /// <returns>
    /// The Base64 encoded string. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Decodes a Base64 encoded string to a plain text string. (EN)
    /// <br/>
    /// Giải mã chuỗi mã hóa Base64 thành chuỗi văn bản thuần túy. (VI)
    /// </summary>
    /// <param name="base64EncodedData">
    /// The Base64 encoded string to decode. (EN)
    /// <br/>
    /// Chuỗi mã hóa Base64 cần giải mã. (VI)
    /// </param>
    /// <returns>
    /// The decoded plain text string. (EN)
    /// <br/>
