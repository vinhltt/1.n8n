...
/// <summary>
/// Helper methods for string manipulation. (EN)
/// <br/>
...
public static class StringHelper
{
    ...
    /// <summary>
    /// Converts a PascalCase or camelCase string to snake_case. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Nullifies a string if it is null or empty after trimming. (EN)
    /// <br/>
    ...
    /// The default value to return if the string is null or empty. (EN)
    /// <br/>
    /// Giá trị mặc định trả về nếu chuỗi là null hoặc rỗng. (VI)
    /// </param>
    /// <param name="trim">
    /// A boolean indicating whether to trim the string before checking for emptiness. (EN)
    /// <br/>
    /// Biến boolean cho biết có cắt khoảng trắng trước khi kiểm tra rỗng hay không. (VI)
    /// </param>
    /// <returns>
    /// The nullified string or the default value. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Trims start, end, and middle spaces in a string. (EN)
    /// <br/>
