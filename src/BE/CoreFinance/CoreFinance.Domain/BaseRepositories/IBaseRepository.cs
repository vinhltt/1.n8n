...
/// <summary>
/// Base interface for repositories. (EN)
/// <br/>
...
{
    /// <summary>
    /// Creates a list of new entities asynchronously. (EN)
    /// <br/>
    /// Tạo một danh sách các thực thể mới một cách bất đồng bộ. (VI)
    /// </summary>
    /// <param name="entities">
    /// The list of entities to create. (EN)
    /// <br/>
    /// Danh sách các thực thể cần tạo. (VI)
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation, containing the number of state entries written to the database. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Updates an existing entity asynchronously. (EN)
    /// <br/>
    /// Cập nhật một thực thể hiện có một cách bất đồng bộ. (VI)
    /// </summary>
    /// <param name="entity">
    /// The entity to update. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Updates a collection of existing entities asynchronously. (EN)
    /// <br/>
    /// Cập nhật một tập hợp các thực thể hiện có một cách bất đồng bộ. (VI)
    /// </summary>
    /// <param name="entities">
    /// The collection of entities to update. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Deletes an entity permanently from the database asynchronously based on its key values. (EN)
    /// <br/>
    /// Xóa vĩnh viễn một thực thể khỏi cơ sở dữ liệu một cách bất đồng bộ dựa trên giá trị khóa của nó. (VI)
    /// </summary>
    /// <param name="keyValues">
    /// The key values of the entity to delete. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Deletes an entity permanently from the database. (EN)
    /// <br/>
    /// Xóa vĩnh viễn một thực thể khỏi cơ sở dữ liệu. (VI)
    /// </summary>
    /// <param name="entity">
    /// The entity to delete. (EN)
    /// <br/>
    /// Thực thể cần xóa. (VI)
    /// </param>
    ...
    /// <summary>
    /// Soft deletes an entity asynchronously based on its key values by marking it as deleted. (EN)
    /// <br/>
    /// Xóa mềm một thực thể một cách bất đồng bộ dựa trên giá trị khóa của nó bằng cách đánh dấu nó đã bị xóa. (VI)
    /// </summary>
    /// <param name="keyValues">
    /// The key values of the entity to soft delete. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Soft deletes an entity asynchronously by marking it as deleted. (EN)
    /// <br/>
    /// Xóa mềm một thực thể một cách bất đồng bộ bằng cách đánh dấu nó đã bị xóa. (VI)
    /// </summary>
    /// <param name="entity">
    /// The entity to soft delete. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Retrieves all entities asynchronously, including specified navigation properties. (EN)
    /// <br/>
    /// Truy xuất tất cả các thực thể một cách bất đồng bộ, bao gồm các thuộc tính điều hướng được chỉ định. (VI)
    /// </summary>
    /// <param name="includes">
    /// Navigation properties to include. (EN)
    /// <br/>
    /// Các thuộc tính điều hướng cần bao gồm. (VI)
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation, containing a list of all entities. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Retrieves an entity by its identifier asynchronously, including specified navigation properties. (EN)
    /// <br/>
    /// Truy xuất một thực thể bằng mã định danh của nó một cách bất đồng bộ, bao gồm các thuộc tính điều hướng được chỉ định. (VI)
    /// </summary>
    /// <param name="id">
    /// The identifier of the entity. (EN)
    /// <br/>
    ...
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation, containing the entity if found, otherwise null. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Retrieves an entity by its identifier without tracking asynchronously, including specified navigation properties. (EN)
    /// <br/>
    /// Truy xuất một thực thể bằng mã định danh của nó mà không theo dõi một cách bất đồng bộ, bao gồm các thuộc tính điều hướng được chỉ định. (VI)
    /// </summary>
    /// <param name="id">
    /// The identifier of the entity. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Retrieves a queryable table for the entity, including specified navigation properties. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Retrieves entities without tracking, including specified navigation properties. (EN)
    /// <br/>
