...
public interface IBaseRepository<TEntity, in TKey> where TEntity : BaseEntity<TKey>
{
    ...
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation, containing the number of state entries written to the database. (EN)<br/>
    ...
    /// <summary>
    /// Retrieves an entity by its identifier without tracking asynchronously, including specified navigation properties. (EN)<br/>
