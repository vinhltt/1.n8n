...
/// <summary>
/// Represents the frequency of recurring transactions. (EN)
/// <br/>
...
{
    /// <summary>
    /// Custom frequency (use CustomIntervalDays). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Weekly frequency (every 7 days). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Biweekly frequency (every 14 days). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Monthly frequency (every 30 days). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Quarterly frequency (every 90 days). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Semi-annually frequency (every 180 days). (EN)
    /// <br/>
    ...
    /// <summary>
    /// Annually frequency (every 365 days). (EN)
    /// <br/>
