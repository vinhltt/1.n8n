...
/// <summary>
/// Represents the Unit of Work pattern interface for managing transactions and repositories. (EN)
/// <br/>
...
{
    /// <summary>
    /// Asynchronously saves all changes made in this unit of work to the database. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Gets a repository for the specified entity type and key type. (EN)
    /// <br/>
    ...
    /// <summary>
    /// Begins a new database transaction asynchronously. (EN)
    /// <br/>
