	...
	<div>
		...
		<div class="space-y-8 pt-5">
			<div class="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
				...
				<span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://headlessui.com/vue/tabs" target="_blank"
					class="block hover:underline">https://headlessui.com/vue/tabs</a>
			</div>
			...
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Simple Tabs</h5>
						...
						<TabList class="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									...
									:class="{ '!border-white-light !border-b-white  text-primary dark:!border-[#191e3a] dark:!border-b-black': selected }">Home</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:text-primary dark:hover:border-b-black"
									:class="{ '!border-white-light !border-b-white text-primary dark:!border-[#191e3a] dark:!border-b-black': selected }">Profile</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:text-primary dark:hover:border-b-black"
									:class="{ '!border-white-light !border-b-white text-primary dark:!border-[#191e3a] dark:!border-b-black': selected }">Contact</a>
							</Tab>
							<Tab as="template" disabled>
								<a href="javascript:;"
									class="pointer-events-none -mb-[1px] block p-3.5 py-2 text-white-light dark:text-dark">Disabled</a>
							</Tab>
						</TabList>
								...
								<div class="flex items-start">
									...
									<div class="flex-auto">
										...
										<p class="text-white-dark">
											...
											nisi vulputate fringilla. Donec lacinia
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Simple Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									...
									:class="{ 'bg-primary text-white': selected }">Home</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2"
									:class="{ 'bg-primary text-white': selected }">Profile</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2"
									:class="{ 'bg-primary text-white': selected }">Contact</a>
							</Tab>
							<Tab as="template" disabled>
								<a href="javascript:;"
									class="pointer-events-none -mb-[1px] block rounded p-3.5 py-2 text-white-light dark:text-dark">Disabled</a>
							</Tab>
						</TabList>
						<TabPanels class="flex-1 pt-5 text-sm">
							<TabPanel>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Icon Tabs</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
						...
						<TabList class="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									...
									<icon-home class="ltr:mr-2 rtl:ml-2" />
									Home
								</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
							...
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] flex items-center border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:text-danger"
									:class="{ '!border-white-light !border-b-white text-danger dark:!border-[#191e3a] dark:!border-b-black': selected }">
									<icon-phone class="ltr:mr-2 rtl:ml-2" />
									Contact
								</a>
							</Tab>
							<Tab as="template" disabled>
								<a href="javascript:;"
									class="pointer-events-none -mb-[1px] flex items-center p-3.5 py-2 text-white-light dark:text-dark">
									<icon-info-circle class="w-5 h-5 ltr:mr-2 rtl:ml-2" />
									Disabled
								</a>
							</Tab>
						</TabList>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Icon Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap gap-2">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
							...
							<Tab as="template" disabled>
								<a href="javascript:;"
									class="pointer-events-none -mb-[1px] flex items-center rounded p-3.5 py-2 text-white-light dark:text-dark">
									<icon-info-circle class="w-5 h-5 ltr:mr-2 rtl:ml-2" />
									Disabled
								</a>
							</Tab>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Vertical Bordered</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
						<div class="mx-10 mb-5 sm:mb-0">
							<TabList class="m-auto w-24 text-center">
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										...
										:class="{ 'bg-success text-white': selected }">Home</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="-mb-[1px] block border border-white-light p-3.5 py-2 !outline-none transition duration-300 hover:bg-success hover:text-white dark:border-[#191e3a]"
										:class="{ 'bg-success text-white': selected }">Profile</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="-mb-[1px] block border border-white-light p-3.5 py-2 !outline-none transition duration-300 hover:bg-success hover:text-white dark:border-[#191e3a]"
										:class="{ 'bg-success text-white': selected }">Messages</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="-mb-[1px] block border border-white-light p-3.5 py-2 !outline-none transition duration-300 hover:bg-success hover:text-white dark:border-[#191e3a]"
										:class="{ 'bg-success text-white': selected }">Settings</a>
								</Tab>
							</TabList>
						</div>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Border Tabs</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						...
						<TabPanels class="flex-1 border border-t-0 border-white-light p-4 text-sm dark:border-[#191e3a]">
...
&lt;/script&gt;
				...
				<div class="panel">
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mb-5 mt-3 flex flex-wrap">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
							...
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="flex items-center border-t-2 border-transparent bg-[#f6f7f8] p-7 py-3 !outline-none transition duration-300 hover:border-secondary hover:text-secondary dark:bg-transparent dark:hover:bg-[#191e3a]"
									:class="{ '!border-secondary text-secondary dark:bg-[#191e3a]': selected }">
									<icon-settings class="w-5 h-5 ltr:mr-2 rtl:ml-2" />
									Settings
								</a>
							</Tab>
						</TabList>
...
&lt;/script&gt;
				...
				<div class="panel">
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mb-5 mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Animated Line</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
						...
						<TabList class="mb-5 mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									...
									:class="{ 'text-secondary before:!w-full': selected }">
									<icon-home class="ltr:mr-2 rtl:ml-2" />
									Home
								</a>
							</Tab>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Vertical Line Tab</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
						<div class="mx-10 mb-5 sm:mb-0">
							<TabList class="m-auto w-24 text-center font-semibold">
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										...
										:class="{ 'text-secondary before:!h-[80%]': selected }">Home</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="relative -mb-[1px] block border-white-light p-3.5 py-4 !outline-none transition duration-300 before:absolute before:bottom-0 before:top-0 before:m-auto before:h-0 before:w-[1px] before:bg-secondary before:transition-all before:duration-700 hover:text-secondary hover:before:h-[80%] ltr:border-r ltr:before:-right-[1px] rtl:border-l rtl:before:-left-[1px] dark:border-[#191e3a]"
										:class="{ 'text-secondary before:!h-[80%]': selected }">Profile</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="relative -mb-[1px] block border-white-light p-3.5 py-4 !outline-none transition duration-300 before:absolute before:bottom-0 before:top-0 before:m-auto before:h-0 before:w-[1px] before:bg-secondary before:transition-all before:duration-700 hover:text-secondary hover:before:h-[80%] ltr:border-r ltr:before:-right-[1px] rtl:border-l rtl:before:-left-[1px] dark:border-[#191e3a]"
										:class="{ 'text-secondary before:!h-[80%]': selected }">Messages</a>
								</Tab>
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="relative -mb-[1px] block border-white-light p-3.5 py-4 !outline-none transition duration-300 before:absolute before:bottom-0 before:top-0 before:m-auto before:h-0 before:w-[1px] before:bg-secondary before:transition-all before:duration-700 hover:text-secondary hover:before:h-[80%] ltr:border-r ltr:before:-right-[1px] rtl:border-l rtl:before:-left-[1px] dark:border-[#191e3a]"
										:class="{ 'text-secondary before:!h-[80%]': selected }">Settings</a>
								</Tab>
							</TabList>
						</div>
						<TabPanels class="flex-1 text-sm">
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Tabs</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList
							class="mt-3 flex flex-wrap justify-between border-b border-white-light text-center dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									...
									:class="{ '!border-white-light !border-b-white dark:!border-[#191e3a] dark:!border-b-black': selected }">Home</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block flex-auto border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:border-white-light hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black"
									:class="{ '!border-white-light !border-b-white dark:!border-[#191e3a] dark:!border-b-black': selected }">Profile</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block flex-auto border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:border-white-light hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black"
									:class="{ '!border-white-light !border-b-white dark:!border-[#191e3a] dark:!border-b-black': selected }">Contact</a>
							</Tab>
						</TabList>
						<TabPanels class="flex-1 pt-5 text-sm">
							<TabPanel>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap justify-between space-x-2 text-center rtl:space-x-reverse">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block flex-auto rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Home</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block flex-auto rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Profile</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block flex-auto rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Contact</a>
							</Tab>
						</TabList>
						<TabPanels class="flex-1 pt-5 text-sm">
							<TabPanel>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Center Tabs</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap justify-center border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Center Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap justify-center space-x-2 rtl:space-x-reverse">
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Home</a>
							</Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Profile</a></Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Contact</a></Tab>
						</TabList>
						<TabPanels class="flex-1 pt-5 text-sm">
							<TabPanel>
								<h4 class="mb-4 text-2xl font-semibold">We move your world!</h4>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Right Tabs</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap justify-end border-b border-white-light dark:border-[#191e3a]">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block border border-transparent p-3.5 py-2 !outline-none transition duration-300 hover:border-white-light hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black"
									:class="{ '!border-white-light !border-b-white text-primary dark:!border-[#191e3a] dark:!border-b-black': selected }">Home</a>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Right Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mt-3 flex flex-wrap justify-end space-x-2 rtl:space-x-reverse">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="-mb-[1px] block rounded p-3.5 py-2 !outline-none transition duration-300 hover:bg-info hover:text-white"
									:class="{ 'bg-info text-white': selected }">Home</a>
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Pills with Icon</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList
							class="mb-5 mt-3 grid grid-cols-4 gap-2 rtl:space-x-reverse sm:flex sm:flex-wrap sm:justify-center sm:space-x-3">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
							...
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
									class="flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] p-7 py-3 !outline-none transition duration-300 hover:!bg-success hover:text-white hover:shadow-[0_5px_15px_0_rgba(0,0,0,0.30)] dark:bg-[#191e3a]"
									:class="{ '!bg-success text-white': selected }">
									<icon-settings class="w-5 h-5 mb-1" />
									Settings
								</a>
							</Tab>
						</TabList>
					...
					<template v-if="codeArr.includes('code17')">
						<highlight>
							<pre>
&lt;!-- pills with icon --&gt;
&lt;TabGroup as=&quot;div&quot; class=&quot;mb-5&quot;&gt;
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Rounded Pills with Icon</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5">
						<TabList class="mb-5 mt-3 flex flex-wrap justify-center space-x-3 rtl:space-x-reverse">
							<Tab as="template" v-slot="{ selected }">
								<a href="javascript:;"
					...
					<template v-if="codeArr.includes('code18')">
						<highlight>
							<pre>
&lt;!-- rounded pills with icon --&gt;
&lt;TabGroup as=&quot;div&quot; class=&quot;mb-5&quot;&gt;
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Vertical Rounded With Icon</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
						<div class="mx-10 mb-5 sm:mb-0">
							<TabList class="m-auto flex w-24 flex-col justify-center space-y-3">
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
					...
					<template v-if="codeArr.includes('code19')">
						<highlight>
							<pre>
&lt;!-- vertical rounded with icon --&gt;
&lt;TabGroup as=&quot;div&quot; class=&quot;mb-5 flex flex-col sm:flex-row&quot;&gt;
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Vertical Circle With Icon</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
						<div class="mx-10 mb-5 sm:mb-0">
							<TabList class="flex flex-col items-center justify-center space-y-3">
								<Tab as="template" v-slot="{ selected }">
									<a href="javascript:;"
										class="flex h-16 w-16 flex-col items-center justify-center rounded-full bg-[#f1f2f3] !outline-none transition-all duration-300 hover:!bg-info hover:text-white hover:shadow-[0_5px_15px_0_rgba(0,0,0,0.30)] dark:bg-[#191e3a]"
										:class="{ '!bg-info text-white': selected }">
					...
					<template v-if="codeArr.includes('code20')">
						<highlight>
							<pre>
&lt;!-- vertical circle dith icon --&gt;
&lt;TabGroup as=&quot;div&quot; class=&quot;mb-5 flex flex-col sm:flex-row&quot;&gt;
    &lt;div class=&quot;mx-10 mb-5 sm:mb-0&quot;&gt;
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Vertical Pills</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
						<TabList class="mb-5 space-y-2 ltr:pr-4 rtl:pl-4 sm:mb-0 sm:flex-[0_0_20%]">
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
									:class="{ '!bg-success text-white': selected }">Home</a></Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
									:class="{ '!bg-success text-white': selected }">Profile</a></Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
									:class="{ '!bg-success text-white': selected }">Messages</a></Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
									:class="{ '!bg-success text-white': selected }">Settings</a></Tab>
						</TabList>
						<TabPanels class="flex-1 text-sm">
							<TabPanel>
								<h4 class="mb-4 text-2xl font-semibold">We move your world!</h4>
					...
					<template v-if="codeArr.includes('code21')">
						<highlight>
							<pre>
&lt;!-- vertical pills --&gt;
&lt;TabGroup as=&quot;div&quot; class=&quot;mb-5 flex flex-col sm:flex-row&quot;&gt;
...
&lt;/script&gt;
				...
				<div class="panel">
					<div class="mb-5 flex items-center justify-between">
						<h5 class="text-lg font-semibold dark:text-white-light">Justify Vertical Pills Right</h5>
						<a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;"
					...
					<TabGroup as="div" class="mb-5 flex flex-col sm:flex-row sm:gap-4">
						<TabList class="mb-5 space-y-2 sm:order-1 sm:mb-0 sm:flex-[0_0_20%]">
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
									class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
									:class="{ '!bg-success text-white': selected }">Home</a></Tab>
							<Tab as="template" v-slot="{ selected }"><a href="javascript:;"
